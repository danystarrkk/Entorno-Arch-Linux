...
alias lla='/bin/lsd -lha --group-dirs=first'
alias ls='/bin/lsd --group-dirs=first'
alias grepc='/bin/grep --colour=always'
...
function createProyect(){
  mkdir -p src/{img,js,scss/{base,page}}
  touch {gulpfile.js,index.html}
  touch src/{js/app.js,scss/app.scss}
  touch src/scss/{base/{_index.scss,_normalice.scss,_base.scss},page/{_index.scss,_page.scss}}
  echo -e "@forward 'base';\n@forward 'page';" >> src/scss/app.scss
  echo -e "@forward 'page';" >> src/scss/page/_index.scss
  echo -e "@forward 'normalice';\n@forward 'base';" >> src/scss/base/_index.scss
}
